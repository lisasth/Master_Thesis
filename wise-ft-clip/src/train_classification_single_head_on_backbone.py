...
from src.models.utils import MLPHead, get_backbone_and_embedding_dim
...
def train_classification_head_on_backbone(args):
    ...
    # Load models
    backbone, embedding_dim = get_backbone_and_embedding_dim(args.model_type, args.load)
    class_head = MLPHead(input_dim=embedding_dim, hidden_dim=args.hidden_dim, output_dim=1).to(device)
