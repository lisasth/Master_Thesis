...
class ContrastiveImageClassifier(ImageClassifier):
    def __init__(self, image_encoder, classification_head, process_images=True, contrastive_output_size=128):
        super().__init__(image_encoder, classification_head, process_images)
        input_size = self.classification_head.weight.shape[1]
